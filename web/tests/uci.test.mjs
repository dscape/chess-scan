...
test("parses a complete engine line", () => {
  const line = parseInfoLine(
    "info depth 24 seldepth 31 score cp -137 nodes 456789 pv e2e4 e7e5 g1f3",
  );
...
test("rejects malformed principal-variation moves", () => {
