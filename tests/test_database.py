...
@pytest.mark.parametrize(
    "base_version",
    ["argus-v2r5", "chess-steps-v1", "chess-steps-v1r1", "chess-steps-v2"],
)
def test_bootstrap_replaces_old_base_but_preserves_newer_candidate(
    ...
    assert database.get_active_model()["version"] == "chess-steps-v3"

    candidate_path = settings.model_dir / "chess-steps-v3.onnx"
